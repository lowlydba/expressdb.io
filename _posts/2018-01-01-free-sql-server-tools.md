...
All of the below scripts, applications, and websites are free to use when developing, testing,
maintaining, and using SQL Server Express. Using them helps keep underlying database expenses to a minimum and many are an opportunity to support open source software.
